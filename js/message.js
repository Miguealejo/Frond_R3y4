...
function getDatosMessage() {
    $.ajax({
        url: "http://129.146.42.24:8080/api/Message/all",
...
function guardarMessage() {
    ...
    $.ajax({
        ...
        url:"http://129.146.42.24:8080/api/Message/save",
...
function editarMessage() {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://129.146.42.24:8080/api/Message/update",
        type: "PUT",
        data: dataToSend,
...
function borrarMessage(idElemento) {
    ...
    let dataToSend = JSON.stringify(myData);
    $.ajax({
        url: "http://129.146.42.24:8080/api/Message/"+idElemento,
        type: "DELETE",
        data: dataToSend,
        contentType: "application/JSON",
        datatype: "JSON",
...
function obtenerItemEspecificoMessage(items) {
    ...
    $.ajax({
        dataType: "json",
        url: "http://129.146.42.24:8080/api/Message/Message/" + items,
        type: "GET",
        success: function (response) {
